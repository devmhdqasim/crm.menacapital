    ...
    <div className="overflow-y-auto flex-1">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex">
                <DatePicker
                  ...
                  className={`px-3 py-2 pl-10 rounded-lg bg-white/[0.04] text-white border focus:border-[#16A249] focus:outline-none focus:ring-2 focus:ring-[#16A249]/30 transition-all duration-300 text-sm hover:border-[#16A249]/50 ${
          ...
          <div className={`space-y-3 ${isUpdateStatusDisabled() ? 'opacity-40 pointer-events-none' : ''}`}>
            <label className="text-[10px] text-[#00FF7F]/60 font-semibold uppercase tracking-widest block">
                      ...
                      isStatusDisabled('Not Interested')
                        ...
                        : isFinalSelectedStatus('Not Interested')
                          ...
                          : shouldShowNotInterestedAvailable()
                            ? 'bg-white/[0.03] hover:bg-white/[0.06] cursor-pointer border-[#16A249]/10 hover:border-[#16A249]/30 animate-pulse-border-subtle'
                            : 'bg-white/[0.03] hover:bg-white/[0.06] cursor-pointer border-[#16A249]/10 hover:border-[#16A249]/30'
                    }`}>
                      <input
                        type="radio"
              ...
              {modalHotLeadType === 'Demo' && (
                <div className="mt-4 p-4 bg-white/[0.03] rounded-xl border border-white/[0.06] animate-fadeIn">
                  <h4 className="text-[#00FF7F]/80 font-semibold mb-3 flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <input
                        ...
                        className="w-5 h-5 rounded border border-white/10 bg-white/[0.04] checked:bg-[#16A249] checked:border-[#16A249] focus:ring-2 focus:ring-[#16A249]/50 cursor-pointer transition-all"
                      />
              ...
              <textarea
                ...
                className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 bg-white/[0.04] text-white resize-none transition-all duration-300 placeholder-gray-600 ${
                  modalErrors.remarks
                    ...
                    : 'border-white/[0.06] focus:border-[#16A249] focus:ring-[#16A249]/50 hover:border-white/10'
                }`}
              />
            ...
            <div className="space-y-2 pt-4 border-t border-white/[0.06]">
              ...
              <input
                ...
                maxLength={100}
                className="w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 bg-white/[0.04] text-white transition-all duration-300 placeholder-gray-600 border-white/[0.06] focus:border-[#16A249] focus:ring-[#16A249]/50 hover:border-white/10"
              />
              <div className="flex justify-between items-center">
      ...
      <div className="sticky bottom-0 bg-[#1A1A1A] border-t border-white/[0.06] p-4">
        <button
          ...
          className={`w-full px-4 py-3 rounded-xl font-semibold transition-all duration-300 transform ${
            isFormValid()
              ? 'bg-gradient-to-r from-[#16A249] to-[#1C4F2A] text-white hover:from-[#1EB956] hover:to-[#267A3D] shadow-[0_0_20px_rgba(22,162,73,0.15)] hover:shadow-[0_0_30px_rgba(22,162,73,0.25)] hover:scale-[1.01] active:scale-[0.99] cursor-pointer'
      ...
      <style>{`
        ...
        @keyframes pulse-border-subtle {
          0%, 100% {
            border-color: rgba(22, 162, 73, 0.3);
            box-shadow: 0 0 0 0 rgba(22, 162, 73, 0);
          }
          50% {
            border-color: rgba(22, 162, 73, 0.6);
            box-shadow: 0 0 8px 2px rgba(22, 162, 73, 0.2);
          }
        }
