          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#1A1A1A] border-b border-[#16A249]/30">
                <tr>
                  <th className="text-left px-6 py-4 text-[#A8E6B8] font-semibold text-sm uppercase tracking-wider">Role ID</th>
                  <th className="text-left px-6 py-4 text-[#A8E6B8] font-semibold text-sm uppercase tracking-wider">Role Name</th>
                  <th className="text-left px-6 py-4 text-[#A8E6B8] font-semibold text-sm uppercase tracking-wider">Department</th>
                  <th className="text-left px-6 py-4 text-[#A8E6B8] font-semibold text-sm uppercase tracking-wider">User Permissions</th>
                  <th className="text-left px-6 py-4 text-[#A8E6B8] font-semibold text-sm uppercase tracking-wider">Lead Permissions</th>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          {/* <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#16A249] to-[#1C4F2A] flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <form onSubmit={formik.handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-[#2A2A2A] border border-[#16A249]/30 rounded-lg p-6 space-y-4">
              <div className="flex items-center gap-2 border-b border-[#16A249]/30 pb-3">
                  ...
                  <div
                    ...
                    className={`border rounded-lg transition-all duration-300 ${
                      formik.values.features[feature.id]?.enabled
                        ? 'border-[#16A249] bg-[#1A1A1A] shadow-lg shadow-[#16A249]/20'
                        : 'border-[#16A249]/30 bg-[#252525] hover:border-[#16A249]/50'
                    }`}
                  >
                    <div className="p-4">
                      {/* Feature Header */}
                      <div className="flex items-start gap-3 mb-3">
                        <input
                          ...
                          className="mt-1 h-5 w-5 accent-[#16A249] border-gray-600 rounded focus:ring-[#16A249] cursor-pointer transition-transform duration-300 hover:scale-110"
                        />
                      ...
                      {/* Permissions Section */}
                      {formik.values.features[feature.id]?.enabled && (
                        <div className="space-y-3 pt-3 border-t border-[#16A249]/30 animate-fadeIn">
                          {/* Quick Actions */}
                          <div className="flex gap-2">
                            <button
                              type="button"
                              onClick={() => handleSelectAll(feature.id)}
                              className="flex-1 text-xs px-3 py-2 bg-[#16A249] text-black rounded hover:bg-[#1EB956] transition-all duration-300 font-semibold shadow-md hover:shadow-lg hover:scale-105 active:scale-95"
                            >
                              Select All
                            </button>
                            <button
                            ...
                            {permissionTypes.map((permission) => (
                              <label key={permission.id} className="flex items-center gap-2 cursor-pointer p-2 rounded hover:bg-[#2A2A2A] transition-all duration-300 group">
                                <input
                                  ...
                                  className="h-4 w-4 accent-[#16A249] border-gray-600 rounded cursor-pointer transition-transform duration-300 group-hover:scale-110"
                                />
              ...
              {/* Summary Section */}
              <div className="bg-[#1A1A1A] border border-[#16A249]/30 rounded-lg p-4 mt-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-[#00FF7F] font-bold text-xl">
                    ...
                    {Object.entries(formik.values.features)
                      ...
                      .map(([featureId]) => {
                        ...
                        return (
                          <span
                            key={featureId}
                            className="px-3 py-1 bg-[#16A249]/20 text-[#00FF7F] rounded-full text-xs font-medium flex items-center gap-1 animate-fadeIn"
                          >
