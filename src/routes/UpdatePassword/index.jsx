  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#16A249]/5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#1C4F2A]/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className={`w-full max-w-md relative z-10 transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <button
          onClick={() => navigate(-1)}
          className={`mb-6 flex items-center gap-2 text-gray-400 hover:text-[#00FF7F] transition-all duration-300 group ${isLoaded ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}
        ...
        <div className={`mb-8 transition-all duration-700 delay-150 ${isLoaded ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="relative w-10 h-10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
              <div className="absolute inset-0 bg-[#a38239] rounded transition-all duration-300 group-hover:shadow-lg group-hover:shadow-[#16A249]/50"></div>
              <div className="absolute bottom-0 left-0 w-5 h-5 bg-[#1A1A1A] rounded-tl-lg transition-all duration-300"></div>
            </div>
            <div className="flex items-baseline">
              <span className="text-3xl font-medium text-white transition-all duration-300 group-hover:text-[#A8E6B8]">Mena Capital</span>
            </div>
          </div>
        </div>
        ...
        <div className={`mb-8 transition-all duration-700 delay-300 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <div className="flex items-center gap-3 mb-3">
            <div className="p-3 bg-gradient-to-br from-[#16A249]/20 to-[#1C4F2A]/20 rounded-xl border border-[#16A249]/30">
              <Lock className="w-6 h-6 text-[#00FF7F]" />
            </div>
        ...
        <form onSubmit={formik.handleSubmit} className={`space-y-6 transition-all duration-700 delay-500 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <div className="transform transition-all duration-300 hover:scale-[1.01]">
            <label htmlFor="currentPassword" className="block text-[#A8E6B8] font-medium text-lg mb-3 transition-colors duration-300">
              Current Password
            </label>
            <div className="relative group">
              <input
                ...
                className={`w-full px-4 py-4 pr-12 border-2 bg-[#2e2e2e] text-white rounded-lg focus:outline-none text-lg transition-all duration-300 placeholder-gray-500 ${
                  formik.touched.currentPassword && formik.errors.currentPassword
                    ...
                    : 'border-[#16A249] focus:border-[#1EB956] focus:ring-2 focus:ring-[#16A249]/50 hover:border-[#1EB956] hover:shadow-lg hover:shadow-[#16A249]/20'
                }`}
              ...
              <button
                ...
                className={`absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-300 ${
                  focusedField === 'currentPassword' ? 'text-[#00FF7F] scale-110' : 'text-gray-400 group-hover:text-[#00FF7F]'
                }`}
              >
                {showCurrentPassword ? <EyeOff size={22} /> : <Eye size={22} />}
              </button>
              <div className={`absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-[#16A249] to-[#1EB956] transition-all duration-300 ${
          ...
          {/* New Password */}
          <div className="transform transition-all duration-300 hover:scale-[1.01]">
            <label htmlFor="newPassword" className="block text-[#A8E6B8] font-medium text-lg mb-3 transition-colors duration-300">
              New Password
            </label>
            <div className="relative group">
              <input
              ...
              <button
                ...
                className={`absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-300 ${
                  focusedField === 'newPassword' ? 'text-[#00FF7F] scale-110' : 'text-gray-400 group-hover:text-[#00FF7F]'
                }`}
              >
          ...
          {/* Confirm Password */}
          <div className="transform transition-all duration-300 hover:scale-[1.01]">
            <label htmlFor="confirmPassword" className="block text-[#A8E6B8] font-medium text-lg mb-3 transition-colors duration-300">
            ...
            <div className="relative group">
              ...
              <button
                ...
                className={`absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-300 ${
                  focusedField === 'confirmPassword' ? 'text-[#00FF7F] scale-110' : 'text-gray-400 group-hover:text-[#00FF7F]'
                }`}
              >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#16A249] to-[#1C4F2A] text-white font-semibold text-lg py-4 rounded-lg hover:from-[#1EB956] hover:to-[#267A3D] disabled:from-[#0E5A28] disabled:to-[#0D3D1E] disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-[#16A249]/40 transform hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0 relative overflow-hidden group"
          >
          ...
          <div className="flex items-center justify-center gap-2 pt-4 opacity-0 animate-fadeIn" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
            <div className="h-px w-12 bg-gradient-to-r from-transparent to-[#16A249]"></div>
            <div className="w-2 h-2 rounded-full bg-[#16A249] animate-pulse"></div>
            <div className="h-px w-12 bg-gradient-to-l from-transparent to-[#16A249]"></div>
          </div>
        </form>
      </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn">
          <div className="bg-[#2A2A2A] rounded-xl shadow-2xl border border-[#16A249]/30 p-8 max-w-md w-full transform animate-scaleIn">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="w-full bg-[#1A1A1A] rounded-full h-2 overflow-hidden">
                <div className="h-full bg-gradient-to-r from-[#16A249] to-[#1C4F2A] animate-progress"></div>
              </div>
            </div>
          </div>
        </div>
